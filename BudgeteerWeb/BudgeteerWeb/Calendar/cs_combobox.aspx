...
<script runat="server">
	...
	void Page_Load(object o, EventArgs e) {
		myCal.DatePickerMode = true;
		myCal.DatePickerImagePath = "styles/icon2.gif";
		myCal.OnClientDateChanged = "onDateChange";
		myCal.DateMin = new DateTime(1999, 1, 1);
		myCal.DateMax = new DateTime(2010, 12, 31);
	}
</script>
...
<html>
	...
	<body>
	    <form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Calendar - Date picker with comboboxes</b></span>
		    <br /><br />	
			<br /><br /> 
