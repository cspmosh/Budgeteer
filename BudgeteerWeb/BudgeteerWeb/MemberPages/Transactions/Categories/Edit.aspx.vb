...
Partial Public Class Edit2
    ...
    Protected Sub CategoryFormView_ItemUpdated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.FormViewUpdatedEventArgs) Handles CategoryFormView.ItemUpdated
    ...
    Protected Sub ValidateCategoryDescriptionUniqueness(ByVal sender As Object, ByVal e As ServerValidateEventArgs)
        For Each category As BudgeteerService.Category In categories
            If category.CategoryID = CategoryFormView.DataKey.Values(0) Then
                Continue For
            End If
