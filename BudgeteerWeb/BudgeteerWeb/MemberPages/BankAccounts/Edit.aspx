<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/MemberPages/MasterPage.Master" CodeBehind="Edit.aspx.vb" Inherits="BudgeteerWeb.Edit1" %>
<asp:Content ID="bc" ContentPlaceHolderID="breadcrumbs" runat="server"><a href="/MemberPages/BankAccounts/Index.aspx">Bank Accounts</a> > Edit Bank Account</asp:Content>
<asp:Content ID="title" ContentPlaceHolderID="pageTitle" runat="server">Edit Bank Account</asp:Content>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div class="contentContainer">               
        <asp:FormView ID="BankAccountFormView" runat="server" 
            DefaultMode="Edit" DataSourceID="BankAccountDataSource" 
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            runat="server" 
                            ErrorMessage="Please only specify the last 4 digits of an account" 
                    ...
                    <tr>
                        ...
                        <td><asp:CheckBox ID="CheckBox2" runat="server" checked='<%# Bind("Active") %>'/></td>
                    </tr>                                        
                    <tr>
    ...
    <asp:ObjectDataSource ID="BankAccountDataSource" runat="server" 
        ...
        UpdateMethod="UpdateBankAccount">
        <SelectParameters>            
